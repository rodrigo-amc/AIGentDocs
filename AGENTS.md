...
This repository is **AIGenticDocs itself** — the docs-as-code standard plus its tooling. It dogfoods its own framework, with one critical distinction:
...
- **`docs/project/` documents this repo's tooling** (the `aigenticdocs` CLI and MCP server), following the standard like any adopting project would.
