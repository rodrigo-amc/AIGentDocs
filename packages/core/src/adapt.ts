...
export const GENERATION_MARKER = "Generated by `aigenticdocs adapt` — edit AGENTS.md instead; this file is regenerated.";
...
`,
  ...
  cursor: {
    file: ".cursor/rules/aigenticdocs.mdc",
    description: "Cursor project rule pointing to AGENTS.md",
    content: `---
description: AIGenticDocs project instructions
alwaysApply: true
---
...
export async function adaptProject(targetDir: string, tools?: string[]): Promise<AdaptResult> {
  ...
  if (!(await exists(path.join(targetDir, "AGENTS.md")))) {
    throw new Error(`'AGENTS.md' not found in '${targetDir}' — adapters point to it. Run 'aigenticdocs init' first.`);
  }
